...
<head>
	...
	<title>CUSTOMER LIST|ECARS</title>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="title">Customer List <span class="pull-right"><a href="register.php" style="color:#fff !important;"><i class="fa fa-plus">&nbsp;ADD NEW</i></a></span> </h4>
								</div>
										...
										<table id="customersList" class="table table-striped table-bordered bg-white" style="width:100%">
											...
											?>
												<tr>
													...
													<td><a href="editCustomer.php?id=<?php echo $row['id']; ?>"><i class="fa fa-edit" style="font-size:22px;"></i></a></td>
													<td><a href="delCustomer.php?id=<?php echo $row['id']; ?>"><i class="fa fa-trash" style="font-size:22px;"></i></a></td>
												</tr>	
											<?php
												}
											?>	
