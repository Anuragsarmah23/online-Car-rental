											...
											?>
												<tr>
													...
													<form method="post" action="updatePaymentStatus.php">
														...
														<td><button type="submit" style="border:none;outline:none;background:none;cursor:pointer;"><i class="fa fa-check editI"></i>&nbsp;<span style="color:purple;font-size:18px;">UPDATE</span></button></td>
													</form>		
													<td><a href="delPayment.php?id=<?php echo $row['id']; ?>"><i class="fa fa-trash" style="font-size:22px;"></i></a></td>
