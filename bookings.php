										...
										<table id="customersList" class="table table-striped table-bordered bg-white" style="width:100%">
											...
											<?php
												while($row=mysqli_fetch_assoc($q_run)){
													...
													$q3="select * from bill where bookID='$id'";
											...
											?>
												<tr>
													...
													<td><?php echo $row3["totalAmt"]; ?></td>
													<td><a href="deleteBookings.php?id=<?php echo $row['id']; ?>"><i class="fa fa-trash" style="font-size:22px;"></i></a></td>
												</tr>	
											<?php
												}
											?>	
